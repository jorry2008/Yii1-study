    ...
    */
    ...
    public function init()
    {
    	...
    	Yii::app()->setImport(array(
			'bootstrap.behaviors.*',
			'bootstrap.helpers.*',//改写原有的CHtml.php,增加功能
    		'bootstrap.form.*',
			'bootstrap.widgets.*',//各种部件，在原有Yii的基础上，增加功能
        ));
    ...
    public function getAssetsUrl()
    {
        if (isset($this->_assetsUrl)) {
            ...
            $path = Yii::getPathOfAlias('bootstrap.assets');
    ...
    public function registerAssetJs($jsFile, $position = CClientScript::POS_END)
    {
        ...
        Yii::app()->getClientScript()->registerCoreScript('jquery')->registerScriptFile($this->getAssetsUrl() . "/js/{$jsFile}", $position);
        return $this;
    }
